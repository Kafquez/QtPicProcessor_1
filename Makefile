#############################################################################
# Makefile for building: Pic2.app/Contents/MacOS/Pic2
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  Pic2.pro
# Template: app
# Command: /Users/zhaoque/anaconda3/bin/qmake -o Makefile Pic2.pro
#############################################################################
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /Users/zhaoque/anaconda3/bin/qmake -install qinstall
QINSTALL_PROGRAM = /Users/zhaoque/anaconda3/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = Pic21.0.0
DISTDIR = /Users/zhaoque/Qt/Qt6Class_projects/Pic2/.tmp/Pic21.0.0
LINK          = /Library/Developer/CommandLineTools/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=10.13 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/Users/zhaoque/anaconda3/lib
LIBS          = $(SUBLIBS) /Users/zhaoque/anaconda3/lib/libQt5Widgets.dylib /Users/zhaoque/anaconda3/lib/libQt5Gui.dylib /Users/zhaoque/anaconda3/lib/libQt5Core.dylib -framework OpenGL -framework AGL   
...
DIST          = ../../../anaconda3/mkspecs/features/spec_pre.prf \
		...
		Pic2.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = Pic2
DESTDIR       = 
TARGET        = Pic2.app/Contents/MacOS/Pic2
...
EXPORT__PRO_FILE_ = /Users/zhaoque/Qt/Qt6Class_projects/Pic2/Pic2.pro


include /Users/zhaoque/anaconda3/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

Pic2.app/Contents/MacOS/Pic2: ui_mainwindow.h $(OBJECTS)  
	@test -d Pic2.app/Contents/MacOS/ || mkdir -p Pic2.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Pic2.pro ../../../anaconda3/mkspecs/macx-clang/qmake.conf ../../../anaconda3/mkspecs/features/spec_pre.prf \
		../../../anaconda3/mkspecs/qdevice.pri \
		../../../anaconda3/mkspecs/features/device_config.prf \
		../../../anaconda3/mkspecs/common/unix.conf \
		../../../anaconda3/mkspecs/common/mac.conf \
...
Pic2.app/Contents/PkgInfo: 
	@test -d Pic2.app/Contents || mkdir -p Pic2.app/Contents
	@$(DEL_FILE) Pic2.app/Contents/PkgInfo
	@echo "APPL????" > Pic2.app/Contents/PkgInfo
Pic2.app/Contents/Resources/empty.lproj: 
	@test -d Pic2.app/Contents/Resources || mkdir -p Pic2.app/Contents/Resources
	@touch Pic2.app/Contents/Resources/empty.lproj
	
Pic2.app/Contents/Info.plist: 
	@test -d Pic2.app/Contents || mkdir -p Pic2.app/Contents
	@$(DEL_FILE) Pic2.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,Dounicorn.Pic2,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},Dounicorn.Pic2,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},10.13,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Pic2,g" -e "s,@LIBRARY@,Pic2,g" -e "s,\$${EXECUTABLE_NAME},Pic2,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" ../../../anaconda3/mkspecs/macx-clang/Info.plist.app >Pic2.app/Contents/Info.plist

all: Makefile \
		Pic2.app/Contents/PkgInfo \
		Pic2.app/Contents/Resources/empty.lproj \
		Pic2.app/Contents/Info.plist Pic2.app/Contents/MacOS/Pic2
...
moc_mainwindow.cpp: mainwindow.h \
		...
		moc_predefs.h \
		../../../anaconda3/bin/moc
	/Users/zhaoque/anaconda3/bin/moc $(DEFINES) --include /Users/zhaoque/Qt/Qt6Class_projects/Pic2/moc_predefs.h -I/Users/zhaoque/anaconda3/mkspecs/macx-clang -I/Users/zhaoque/Qt/Qt6Class_projects/Pic2 -I/Users/zhaoque/anaconda3/include/qt -I/Users/zhaoque/anaconda3/include/qt/QtWidgets -I/Users/zhaoque/anaconda3/include/qt/QtGui -I/Users/zhaoque/anaconda3/include/qt/QtCore -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/14.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: mainwindow.ui \
		../../../anaconda3/bin/uic
	/Users/zhaoque/anaconda3/bin/uic mainwindow.ui -o ui_mainwindow.h
...
mainwindow.o: mainwindow.cpp mainwindow.h \
		...
		../../../anaconda3/include/qt/QtCore/QRandomGenerator \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Pic2/bin || mkdir -p $(INSTALL_ROOT)/opt/Pic2/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Pic2/bin/Pic2.app
	
	$(QINSTALL) Pic2.app $(INSTALL_ROOT)/opt/Pic2/bin/Pic2.app
	-$(STRIP) $(INSTALL_ROOT)/opt/Pic2/bin/Pic2.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Pic2/bin/Pic2.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Pic2/bin/ 
